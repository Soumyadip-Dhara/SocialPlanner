...
namespace Plannivo.IntegrationTests.Auth;

public class AuthControllerTests : IClassFixture<PlannivoWebApplicationFactory>
{
    private readonly HttpClient _client;

    public AuthControllerTests(PlannivoWebApplicationFactory factory)
    {
