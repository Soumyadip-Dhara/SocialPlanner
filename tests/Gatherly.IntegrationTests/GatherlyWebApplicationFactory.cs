...
namespace Gatherly.IntegrationTests;
...
/// </summary>
public class GatherlyWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    private readonly string _testDbName = $"gatherly-test-{Guid.NewGuid()}";
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration(config =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["JwtSettings:Issuer"] = "Gatherly",
                ["JwtSettings:Audience"] = "GatherlyUsers",
